...
public class ModelFenderiumMob extends ModelFendirain {
    ...
    public ModelFenderiumMob() {
        ...
        this.rightArm2 = new ModelRenderer(this, 23, 5);
        this.rightArm2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.rightArm2.addBox(-2.0F, -1.0F, -1.0F, 2, 7, 2, 0.0F);
        ...
        this.leftArm1 = new ModelRenderer(this, 25, 0);
        this.leftArm1.setRotationPoint(6.4F, 1.8F, 3.0F);
        this.leftArm1.addBox(-0.5F, -1.0F, -1.0F, 1, 2, 2, 0.0F);
        this.rightArm1 = new ModelRenderer(this, 18, 0);
        this.rightArm1.setRotationPoint(-0.4F, 1.8F, 3.0F);
        ...
        this.leftArm2 = new ModelRenderer(this, 23, 15);
        this.leftArm2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.leftArm2.addBox(0.0F, -1.0F, -1.0F, 2, 7, 2, 0.0F);
